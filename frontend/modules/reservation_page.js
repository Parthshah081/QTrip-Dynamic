...
function addReservationToTable(reservations) {
 ...
 reservations.map((ele, idx)=>{
  ...
  userData.innerHTML = `<th scope="row">${ele.id}</th>
  <td>${ele.name}</td>
  ...
  <td><div class="reservation-visit-button" id="${ele.id}"><a href="../detail/?adventure=${ele.adventure}">Visit Adventure</a></div></td>`

  document.getElementById("reservation-table").append(userData);
})
  /*
